...
public class CruddemoApplication {
    ...
    private void addMoreCoursesForStudent(AppDAO appDAO) {
        ...
        //create more courses
        Course tempCourse1 = new Course("do maths without practice ");
        Course tempCourse2 = new Course("electric guitar ");
    ...
    private void createCourseAndStudent(AppDAO appDAO) {
        ...
        //create the students
        Student tempStudent1 = new Student("john","doe","john123doe@luv2code.com");
        Student tempStudent2 = new Student("mary","philips","mary123philips@luv2code.com");
